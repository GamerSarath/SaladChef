...
public class Remy : Characters
{
    ...
    public Remy(int speedValue, int agilityValue, int patienceValue, string specialMove, int unlockPrice) // constructor to initialize the character attributes
    {
