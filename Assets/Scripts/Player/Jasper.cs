...
public class Jasper : Characters
{
    [SerializeField]
    ...
    public Jasper(int speedValue, int agilityValue, int patienceValue, string specialMove, int unlockPrice) // constructor to initialize the character attributes
    {
