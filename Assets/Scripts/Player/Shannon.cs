...
public class Shannon : Characters
{
    [SerializeField]
    ...
    public Shannon(int speedValue, int agilityValue, int patienceValue, string specialMove, int unlockPrice) // constructor to initialize the character attributes
    {
